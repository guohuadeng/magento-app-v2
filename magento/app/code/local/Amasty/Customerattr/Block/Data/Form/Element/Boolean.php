 ...
 */
class Amasty_Customerattr_Block_Data_Form_Element_Boolean extends Varien_Data_Form_Element_Abstract
{
    ...
    protected function _optionToHtml($option, $selected)
    {
        if (is_array($option['value'])) {
			...
			$html.= '>' . Mage::helper('amcustomerattr')->__($this->_escape($option['label'])) . '</option>' . "\n";
        }
        return $html;
    }
